...
public abstract class FeastDayDetail : SmartEnum<FeastDayDetail>
{
	...
	private static class Id
	{
		...
		internal const int Hanukkah = 14;    
		internal const int Purim = 15;    
	}
	#endregion
	...
	public static readonly FeastDayDetail Hanukkah = new HanukkahSE();
	...
	private sealed class OmerStartSE : FeastDayDetail
	{
		...
		public override int ParentFeastDayId => Enums.FeastDay.Passover.Value;
		public override int AddDays => 2;  // If Sadducee interpretation, it's always 2
	...
	private sealed class HanukkahSE : FeastDayDetail
	{
		public HanukkahSE() : base($"{nameof(Id.Hanukkah)}", Id.Hanukkah) { }
		public override int ParentFeastDayId => FeastDay.Hanukkah.Value;
		public override int AddDays => 0;
		public override string Descr => "This is the last day of Hanukkah; date determined by Rabbinic source";
	}
	...
	private sealed class PurimSE : FeastDayDetail
	{
		...
		public override int ParentFeastDayId => FeastDay.Purim.Value;
		public override int AddDays => 0;
		public override string Descr => "Date determined by Rabbinic source";
	}
