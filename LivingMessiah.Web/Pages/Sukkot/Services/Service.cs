...
public interface IService
{
		...
		Task<ViewModel_RE_DELETE> GetById(int id);
		Task<(int NewId, int SprocReturnValue, string ReturnMsg)> Create(ViewModel_RE_DELETE registration);
		Task<(int RowsAffected, int SprocReturnValue, string ReturnMsg)> Update(ViewModel_RE_DELETE registration);
}
...
public class Service : IService
{
		...
		public async Task<ViewModel_RE_DELETE> GetById(int id)
		{
				string message = $"Inside {nameof(Service)}!{nameof(GetById)}, id={id}";
				Logger.LogInformation(message);

				ViewModel_RE_DELETE VM = new();
				try
				{
		...
		public async Task<(int NewId, int SprocReturnValue, string ReturnMsg)> Create(ViewModel_RE_DELETE vm)
		{
		...
		public async Task<(int RowsAffected, int SprocReturnValue, string ReturnMsg)> Update(ViewModel_RE_DELETE vm)
		{
		...
		private RegistrationEntry.DTO DTO_From_VM_To_DB(ViewModel_RE_DELETE vm)
		{
