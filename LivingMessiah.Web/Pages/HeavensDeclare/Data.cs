	...
	public static class Data
	{
		public static List<Video> GetAll()
		{
			return new List<Video>
			{
				...
				, new Video {UrlId="Hk_LKCRkQ68", Title="Reunion Roadmap Signs in the Heaven - Part 3" }
				, new Video {UrlId="FZkl3plwqZ8", Title="Remnant of Yisrael Signs in the Heavens #4" }
			};
