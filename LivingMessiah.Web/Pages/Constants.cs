namespace LivingMessiah.Web.Pages
{
	public static class SyncFusionToolbar
	{
		/*
		<SfGrid ID="Grid" @ref="Grid" Toolbar="@(new List<string>() { SyncFusionToolbar.Excel.Arg, SyncFusionToolbar.Csv.Arg, SyncFusionToolbar.Pdf.Arg, SyncFusionToolbar.Print.Arg })"
		 */
