...
namespace SukkotApi.Domain
{
	...
	// Needs to sink with `public List<SelectListItem> LodgingDays...` (Pages\Sukkot\CreateEdit.cshtml.cs)
	public class LodgeDate
	{
		public static List<LodgeDate> All { get; } = new List<LodgeDate>();
		public static LodgeDate Day01 { get; } = new LodgeDate(LodgeDateEnum.Day01, SukkotLodgingDays.Sep_30_Wed, "2020-09-30", "Wed, Sep 30<sup>th</sup>");
		public static LodgeDate Day02 { get; } = new LodgeDate(LodgeDateEnum.Day02, SukkotLodgingDays.Oct_01_Thu, "2020-10-01", "Thu, Oct 01<sup>th</sup>");
		public static LodgeDate Day03 { get; } = new LodgeDate(LodgeDateEnum.Day03, SukkotLodgingDays.Oct_02_Fri, "2020-10-02", "Fri, Oct 02<sup>th</sup>");
		public static LodgeDate Day04 { get; } = new LodgeDate(LodgeDateEnum.Day04, SukkotLodgingDays.Oct_03_Sat, "2020-10-03", "Sat, Oct 03<sup>th</sup>");
		public static LodgeDate Day05 { get; } = new LodgeDate(LodgeDateEnum.Day05, SukkotLodgingDays.Oct_04_Sun, "2020-10-04", "Sun, Oct 04<sup>th</sup>");
		...
		public SukkotLodgingDays LodgingDayFlag { get; private set; }
		public string Name { get; private set; }
		public DateTime LodgeDateTime { get; private set; }
		public string DateHtml { get; private set; }

		private LodgeDate(LodgeDateEnum LodgeDatesEnum, SukkotLodgingDays lodgingDayFlag, string dateString, string dateHtml)
		{
			LodgeDateEnum = LodgeDatesEnum;
			LodgingDayFlag = lodgingDayFlag;
			Name = dateString;
			LodgeDateTime = DateTime.Parse(dateString);
			DateHtml = dateHtml;
			All.Add(this);
		}
...
*/
		...
		public static LodgeDate FromString(string formatString)
		{
			return All.Single(r => String.Equals(r.Name, formatString, StringComparison.OrdinalIgnoreCase));
		}

		private const LodgeDateEnum lastDay = LodgeDateEnum.Day08; // LodgeDateEnum.Day11;


		public static LodgeDate FromEnum(LodgeDateEnum enumValue)
		{
			return All.SingleOrDefault(r => r.LodgeDateEnum == enumValue);
		}
		...
		{
			Dictionary<string, string> d = new Dictionary<string, string>();
			foreach (LodgeDate f in All)
			{
				d.Add(f.LodgeDateEnum.ToString(), f.Name);
			}
			return d;
		}
	}
